...
public class TestBaseTC1andTC6andTC9 {
	...
	public void setUp(String Browser, String Url) {
			...
			try {
			fileLoc = new FileInputStream("C:\\Users\\kudumalau\\Downloads\\selenium_assigment-master\\selenium_assigment-master\\OrangeHRMApplication.Selenium\\Configuration\\config.properties");
			prop = new Properties();
			prop.load(fileLoc);
		}catch(Exception e) {
			e.printStackTrace();
